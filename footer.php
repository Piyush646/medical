            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6" >
                    <div class="cv-foot-box cv-foot-contact" style="padding-left:15em;">
                        <h2>Useful Links</h2>
                        <ul>
                            <li><a style="margin-left:2.5em"href="index">Home</a></li>
                            <li><a style="margin-left:2.6em"href="shop">Shop</a></li>
                            <li><a style="margin-left:2.4em"href="about">About</a></li>
                            <li><a style="margin-left:1.5em"href="contact">Contact Us</a></li>
                        </ul>
                    </div>
