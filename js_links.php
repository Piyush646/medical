<!-- main wrapper end -->
    ...
    <script src="assets/js/custom.js"></script>
     ...
     <script src="https://code.jquery.com/jquery-3.5.1.min.js" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
        ...
        var wpcf7 = {"apiSettings":{"root":"https:\/\/omnitex-uk.com\/wp-json\/contact-form-7\/v1","namespace":"contact-form-7\/v1"}};
        </script>
        <script src='https://omnitex-uk.com/wp-content/plugins/contact-form-7/includes/js/scripts.js?ver=5.3.2' id='contact-form-7-js'></script>
        <script src='https://omnitex-uk.com/wp-content/themes/omnitex/js/navigation.js?ver=1.0.0' id='omnitex-navigation-js'></script>
        <script src='https://omnitex-uk.com/wp-includes/js/wp-embed.min.js?ver=5.6' id='wp-embed-js'></script>
</body>